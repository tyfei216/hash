...
config['train'] = {'epoch':80, 'd_epoch':20, 'lr':0.0002, 'step':40, 'gamma': 0.8, 'train_encoder': 2, 'train_generator': 2,
                    'weight_decay':0.0005, 'momemtum':0.5,'adam':0.5, 'warmup':9,
                    'beta':1.5, 'save_epoch':15, 'print': 3, 
